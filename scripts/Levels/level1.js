...
function addPlatforms1(level, canvas) {
    ...
    level[1].push(new Platform(canvas.width * 2 + 425, 150, 75));
    level[1].push(new Platform(canvas.width * 2 + 425, 50, 100));
...
function addMonsters1(level, canvas) {
    ...
    //section 3
    level[2].push(new Monster(canvas.width * 2 + 215, 325));
    level[2].push(new Monster(canvas.width * 2 + 280, 325));
    level[2].push(new Monster(canvas.width * 2 + 300, 325));
    ...
    level[2].push(new Monster(canvas.width * 2 + 430, 125));
    level[2].push(new Monster(canvas.width * 2 + 430, 225));
